<template>
	...
	<div class="wrap_top">
    	<div class="top">
        	<div class="logo"><a href="#"><img src="../assets/images/logo.jpg" width="200" height="74" /></a></div>
            <div id="navMenu">
                <UL class="menu1">
                    <li class="onelink" @click="info(1)">网站首页</li>
                    <li class="navthis1" @click="info(2)">作品欣赏
                        <ul>
                            <li><a href="#">特色内景</a></li>
                            <li><a href="#">时尚写真</a></li>
                            <li><a href="#">高端外景</a></li>
                    ...
                    <li class="navthis27" @click="info(8)">微博评价</li>   
